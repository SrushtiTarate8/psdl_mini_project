...
class reportClass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text='Clear',font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2").place(x=800,y = 100,width=100,height=35)  
        ...
        lbl_marks=Label(self.root,text="Marks Obtained",font=("goudy old style",20,"bold"),bg="white",bd=2,relief=GROOVE).place(x=600,y=230,width=200,height=50)
        lbl_full=Label(self.root,text="Total Marks",font=("goudy old style",20,"bold"),bg="white",bd=2,relief=GROOVE).place(x=800,y=230,width=150,height=50)
        lbl_per=Label(self.root,text="Percentage",font=("goudy old style",20,"bold"),bg="white",bd=2,relief=GROOVE).place(x=950,y=230,width=150,height=50)  
