...
class studentClass:
    def __init__(self,root):
        ...
        #===title====
        title=Label(self.root,text="Manage Stdent Details", font=("goudy old style",20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=35)
        #===Variables====
    ...
    def delete(self):
        ...
        try:
            if self.var_roll.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Please student course from list",parent=self.root)
                else:
